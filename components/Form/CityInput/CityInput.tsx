// components/Form/CityInput/CityInput.tsx
'use client';
...
interface CityInputProps {
    ...
    placeholder: string;
    value: string;
    onChange: (city: string, lat: number | unknown, lng: number | unknown) => void;
    isRequired?: boolean;
    disabled?: boolean;
    error?: string;
}
...
const CityInput: React.FC<CityInputProps> = (props) => {
    ...
    return <CityInputInner {...props} />;
};

const CityInputInner: React.FC<CityInputProps> = ({
    name,
    label,
    placeholder,
    value,
